...
public class MongobasicoApplication {
    ...
    CommandLineRunner start(JournalService service) {
        return args -> {
            ...
            service.saveJournal(new Journal("Get to know Spring Boot",
                    "Today I will learn Spring Boot", "01/02/2016"));
            service.saveJournal(new Journal("Simple Spring Boot Project",
                    "I will do my first Spring Boot Project", "01/03/2016"));
            service.saveJournal(new Journal("Spring Boot Reading",
                    "Read more about Spring Boot", "02/02/2016"));
            service.saveJournal(new Journal("Spring Boot in the Cloud",
